...
// I just edit it a bit, to make it easier to use. 			- Marcelino Porcar
...
public class ShooterGameCamera : MonoBehaviour {
	...
	public Texture crosshair; // crosshair - removed it for quick and easy setup. 
	
	protected Transform aimTarget; // that was public and a gameobject had to be dragged on it. 
	
	public float smoothingTime = 10.0f; // it should follow it faster by jumping (y-axis) (previous: 0.1 or so)
	public Vector3 pivotOffset = new Vector3(0.2f, 0.7f,  0.0f); // offset of point from player transform (?)
	public Vector3 camOffset   = new Vector3(0.0f, 0.7f, -3.4f); // offset of camera from pivotOffset (?) 
	public Vector3 closeOffset = new Vector3(0.35f, 1.7f, 0.0f); // close offset of camera from pivotOffset (?)
	
	public float horizontalAimingSpeed = 800f; // was way to lame for me (270) 
	public float verticalAimingSpeed = 800f;   // --"-- (270) 
	...
	void LateUpdate () {
		...
		// I removed this, so you can quick and easy add this script to your game.
													 // @joystick 3rd axis
	...
	// to your player or something else. 
	public void SetTarget(Transform t)
	{
		player=t;
	}
	
	// uncomment this if you want to have a crosshair 
